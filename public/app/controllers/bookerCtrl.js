...
.controller('daySelectorController', function($rootScope, $location, $cookies, Schedule, User, Auth) {
	...
	vm.alert = function(){
		alert("Sorry. You cannot book until after "+vm.lockoutYear+ "-" +(vm.lockoutMonth+1)+ "-"+vm.lockoutDay+" after "+vm.lockoutHour+":00 "+((vm.lockoutHour < 13) ? "AM" : "PM") +" because you cancelled a booking within 5 hours of it's start time. Thanks!" );
	};
})
